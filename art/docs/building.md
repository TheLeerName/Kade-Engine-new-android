# Building Friday Night Funkin': Kade Engine Android Port

I made a little edit of build instructions, maybe i will use other haxe libraries
...
# Quick solutions of some errors
...
If it does not compile for you on windows (not creating .exe file), delete the export folder (for this you will need to wait for compilation for more than an hour) or reinstall haxe 4.1.5 (i fixed this by deleting export folder)
